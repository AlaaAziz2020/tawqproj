import React, { useState } from "react";
    ...
    return (
     ...
     {/* <button className="slide-btn right" onClick={prevSlide}>
          ...
          <div className="product-info col-md-6">
            <h2 className="product-title"> تيشيرت شتوي </h2>
  ...
  <div className="action mt-3  d-flex justify-content-center">
      <div className="installement ">
          ...
          <h4 className="ins-text text-white"  >شحن دولي وداخلي</h4>
      </div>
          <div className="international ">
          <img src={international} style={{ width: "4%",fontSize: "21px"}} />
          <h4 className="ins-text text-white">تقسيط</h4>
      </div>
  </div>
  {/* قسم المشاركة */}
